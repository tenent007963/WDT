...
<header class="navbar">
      ...
      <a onclick="loadPage('/view/account/accView.php')"><img class="account" src="https://cdn2.iconfinder.com/data/icons/minimal-set-three/32/minimal-58-512.png" alt="account"></a>
      <a onclick="loadPage('/view/misc/support.php')"><img class="support" src="https://cdn.icon-icons.com/icons2/3106/PNG/512/question_help_icon_191660.png" alt="support"></a>
